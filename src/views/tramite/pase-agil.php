            ...
            <div class="col-lg-6">
                ...
                <div class="form-card text-center">
                    ...
                    <div class="form-card-body">
                        ...
                        <img src="<?= htmlspecialchars($qrUrl) ?>" alt="Código QR Pase Ágil"
                             class="img-fluid border rounded mb-4" style="max-width: 220px;">

                        <div class="card mx-auto mb-4" style="max-width: 360px;">
                            <div class="card-body text-start">
                                <p class="mb-1"><strong>Viajero:</strong> <?= htmlspecialchars($tramite->viajero_nombre ?? '') ?></p>
                                <p class="mb-1"><strong>Paso fronterizo:</strong> <?= htmlspecialchars($tramite->paso_fronterizo ?? '') ?></p>
                                <p class="mb-0">
                                    <strong>Estado:</strong>
                                    <span class="badge bg-success rounded-pill px-3 py-2 text-uppercase"><?= htmlspecialchars($tramite->estado) ?></span>
                                </p>
                            </div>
                        </div>

                        <a href="/portal/viajero" class="btn btn-prev">
